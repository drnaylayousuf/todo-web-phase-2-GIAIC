...
**Tests**: The examples below include test tasks. Tests are MANDATORY per Constitution Test-First Mandate - include comprehensive test suite covering integration tests for user journeys and unit tests for complex business logic.
...
- [ ] T012 [P] [US1] Unit tests for complex business logic in tests/unit/test_[name].py
...
- [ ] T021 [P] [US2] Unit tests for complex business logic in tests/unit/test_[name].py
...
- [ ] T028 [P] [US3] Unit tests for complex business logic in tests/unit/test_[name].py
